...
class CreateAddressPoliceStationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('address_police_stations', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('address_police_stations');
    }
}
