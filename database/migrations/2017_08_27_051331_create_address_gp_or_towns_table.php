...
class CreateAddressGpOrTownsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('address_gp_or_towns', function (Blueprint $table) {
            $table->increments('id');
            $table->string('gpORtown');
    ...
    {
        Schema::dropIfExists('address_gp_or_towns');
    }
}
