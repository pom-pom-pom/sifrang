...
<html lang="en">
<head>
<title>Oil Industry an Industrial Category Flat Bootstrap Responsive Website Template | Gallery :: w3layouts</title>
<!-- custom-theme -->
...
<!-- gallery -->
	<div class="banner-bottom">
		<div class="container">
		 <h3 class="w3l_header">Gallery</h3>
			...
			<div class="w3ls_gallery_grids">
				...
				<div class="col-md-4 w3_agile_gallery_grid">
					...
					<div class="agile_gallery_grid">
						<a title="Donec sapien massa, placerat ac sodales ac, feugiat quis est." href="images/1g2.jpg">
							<div class="agile_gallery_grid1">
								<img src="images/g2.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_gallery_grid1_pos">
									<h3>Oil Industry</h3>
