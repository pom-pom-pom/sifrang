...
<div class="header">
		...
		<div class="w3layouts_header_right">
			<ul>
				<li><i class="fa fa-phone" aria-hidden="true"></i>+91-9859353587</li>
				<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:xstvindia@gmail.com">xstvindia@gmail.com</a></li>
			</ul>
		</div>
		...
		<div class="w3ls_agile_header_inner">	
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--juliet col-md-offset-1">
						<ul class="nav navbar-nav">
							<li class="active"><a href="index.html">Home</a></li>
							<li><a href="/awareness" >Awareness</a></li>
							<li><a href="gallery.html">Financial</a></li>
							<li><a href="gallery.html">Surveys</a></li>
							<li><a href="gallery.html">Education</a></li>
							<li><a href="gallery.html">Shopping</a></li>
							<li><a href="gallery.html">Franchise</a></li>
	...
	<div class="footer">
		<div class="container">
			...
			<div class="col-md-4 agile_footer_grid">
				<h3>Contact Info</h3>
				<ul class="w3_address">
					<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>SIFRANG,Gopal Nagar,Hojai,Assam,India-782435</span></li>
					<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:xstvindia@gmail.com">xstvindia@gmail.com</a></li>
					<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+91-9859353587</li>
				</ul>
			</div>
			<div class="clearfix"> </div>
			...
			<div class="agileinfo_copyright">
				<p>© 2017 Oil Industry. All rights reserved</p>
			</div>
		</div>
	</div>
<!-- //footer -->
